function locationCard(settings) {
    ...
    function createC(citys) {
        ...
        //如果没有创建过
        html += '<div id="__' + cityInputId + '" class="citys clearfix" style="display:none;border:2px solid #4490f7;">';
        for (var i = 0; i < citys.length; i++) {
            html += '<a class="a" href="javascript:;">' + citys[i] + '</a>';
        }
        html += '</div>';
    ...
    function createP() {
        ...
        //如果没有创建过
        var html = '<div id="__' + provinceInputId + '" class="privinces clearfix" style="display:none;border:2px solid #4490f7;">';
