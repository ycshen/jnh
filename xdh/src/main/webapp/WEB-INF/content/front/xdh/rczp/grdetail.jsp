...
<body>
	...
	<div style="width:1000px;margin-left:auto;margin-right:auto;margin-top:10px;color:#444;font-size:14px;">
		...
		->
		<a href="http://www.52jnh.com/xdh/rc.html"  style="color:#444;font-size:14px;">嘉年华婚礼创意馆人才招聘</a>
		->
		个人求职信息-${obj.myname}<span style="color:#1c86ee;">[${obj.position}]</span>
	</div>
	<div style="width:1000px;margin-left:auto;margin-right:auto;">
		<div style="float:left;width:1000px;font-size: 20px;color:#444;font-weight:bold;margin-top:10px;line-height:40px;">
			
			${obj.myname}<span style="color:#1c86ee;">[${obj.position}]</span>[${obj.createDate}]
		</div>
		<div style="float:left;width:1000px;margin-top:10px;">
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">求职职位：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:150px;text-align:left;">${obj.position}</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">求职工作地点：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;text-align:left;">${obj.place}</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">籍贯：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;text-align:left;">${obj.sourceAddr}</div>
		</div>
		...
		<div style="float:left;width:1000px;margin-top:10px;">
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">期望薪水：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:150px;text-align:left;"><span style="font-weight:bold;color:red;font-size:16px;">${obj.salary}</span>&nbsp;元/月起</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">期望工作方式：</div>
		...
		<div style="float:left;width:1000px;margin-top:10px;">
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">性&nbsp;&nbsp;&nbsp;&nbsp;别：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:150px;text-align:left;">${obj.sex }</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">年&nbsp;&nbsp;&nbsp;&nbsp;龄：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;text-align:left;">${obj.age}岁</div>
		...
		<div style="float:left;width:1000px;margin-top:10px;">
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:100px;">婚姻状况：</div>
			<div style="font-size:14px;color:#666;line-height:28px;float:left;width:150px;text-align:left;">${obj.marryStatus}</div>
