...
<body>
	...
	<div class="container">
		<img src="${pageContext.request.contextPath}/assets/img/wz/customPrice.jpg" class="img-responsive"/>	
		<div class="table-responsive">
			
			<table class="table">
				<tr>
					<td>报&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：</td>
					<td><span class="font14">5000元（终身,不包括服务器+域名）</span></td>
				</tr>
				<tr>
					<td>续费项目：</td>
				...
				<tr class="danger">
					<td>第一年安装总价：</td>
					<td><span class="font14">5000(网站)+700（服务器）+60（域名）=5760（元）</span></td>
				</tr>
				<tr>
					<td>报价单下载：</td>
				...
				<tr>
					<td>合作流程：</td>
					<td>
						签订合同----支付首款--首页页面设计----首页页面修改--首页页面确认--二级页面设计--二级页面修改--<br/>
						二级页面确认--功能书面确认--页面切片--程序开发---内测--网站验收--支付尾款--上线运行--提交百度收录。
					</td>
				</tr>
				<tr>
					<td>付款方式：</td>
