				...
				<div class="portlet-body form">
					...
					<div class="form-horizontal form-view">
						...
						<div class="row-fluid">
							...
							<div class="span6 ">
								<div class="control-group">
									<label class="control-label" for="lastName">会员名:</label>
									<div class="controls">
						...
						<div class="row-fluid">
							...
							<div class="span6 ">
								<div class="control-group">
									<label class="control-label">是否是VIP:</label>
									<div class="controls">
										<span class="text bold">${obj.status eq 2 ? '非VIP':'VIP' }</span>
									</div>
								</div>
							</div>
							<!--/span-->
						...
						<div class="row-fluid">
							<div class="span12 ">
								...
								<div class="control-group">
									...
									<div class="controls">
										<span class="text bold">${obj.phone }</span>
									</div>
								</div>
							</div>
						</div>
						<div class="row-fluid">
							<div class="span12 ">
								<div class="control-group">
									...
									<div class="controls">
										<span class="text bold">${obj.qq }</span>
									</div>
								</div>
							</div>
							</div>
