...
<body>
	<div class="page-content">
		<div class="container-fluid">
			<!-- 页面导航 -->
			<tool:navBar pageTitle="招聘信息列表" pageTitleContent="系统管理-招聘信息-招聘信息列表" titleIcon="icon-home"/>
			<!-- 主体内容 -->
			<div class="row-fluid">
				<div class="span12">
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							<div class="row-fluid">
								...
								<tool:operBtns3 modelKey="user"></tool:operBtns3>
							</div>
...
$(document).ready(function() {
	//高亮左侧菜单
	App.activeMenu("cms/recruit/list");
	Page.initData(
		{
			url:"${ctx}/cms/recruit/page",
			tableId : "#sample_1",
			pageSize : 10
		},
		null,
		[{cName:"company",cValue:"公司"},
		 {cName:"position",cValue:"招聘职位"},
		 {cName:"place",cValue:"工作地点"},
		 {cName:"salaryStart",cValue:"薪水（最低/月）"},
		 {cName:"salaryEnd",cValue:"薪水（最高/月）"},
		 {cName:"hits",cValue:"访问量"},
		 {cName:"workWay",cValue:"工作方式"},
		 {cName:"eduDegree",cValue:"学历"},
		 {cName:"sex",cValue:"性别要求"},
		 {cName:"workTime",cValue:"工作经历（以上）"},
		 {cName:"personNum",cValue:"招聘人数"},
