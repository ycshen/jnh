...
<html>
<head>
<title>审核招聘信息列表</title>
</head>
<body>
	<div class="page-content">
		<div class="container-fluid">
			<!-- 页面导航 -->
			<tool:navBar pageTitle="审核招聘信息列表" pageTitleContent="系统管理-审核招聘信息-审核招聘信息列表" titleIcon="icon-home"/>
			<!-- 主体内容 -->
			<div class="row-fluid">
				<div class="span12">
...
$(document).ready(function() {
	//高亮左侧菜单
	App.activeMenu("cms/recruit/slist");
	Page.initData(
		{
			url:"${ctx}/cms/recruit/auditpage",
			tableId : "#sample_1",
			pageSize : 10
		},
		null,
