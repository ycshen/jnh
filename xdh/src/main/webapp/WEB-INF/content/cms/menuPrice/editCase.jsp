	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<tool:navBar pageTitle="${pageTitle }"
				pageTitleContent="婚礼套餐-套餐名称管理-${pageTitle }" titleIcon="diy_icon_01_46" />
			<!-- 主体内容 -->
			<div class="row-fluid">
				<div class="span12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<h4>
								<i class="icon-reorder"></i>请填写套餐名称信息
							</h4>
							<div class="tools">
						...
						<div class="portlet-body form">
							<%@ include file="/WEB-INF/content/cms/menuPrice/form/ueditorCase.jsp"%>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function initSelect(){
		...
		$("#selectCaseType").live("change", function(){
			var selectIndex = document.getElementById("selectCaseType").selectedIndex;
			document.getElementById("selectSort").selectedIndex = selectIndex;
		});
		$("#selectSort").live("change", function(){
			var selectIndex = document.getElementById("selectSort").selectedIndex;
			document.getElementById("selectCaseType").selectedIndex = selectIndex;
