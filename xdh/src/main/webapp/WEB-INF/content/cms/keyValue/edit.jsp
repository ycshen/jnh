	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<tool:navBar pageTitle="${pageTitle }"
				pageTitleContent="cms-参数设置管理-${pageTitle }" titleIcon="diy_icon_01_46" />
			<!-- 主体内容 -->
			<div class="row-fluid">
				<div class="span12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<h4>
								<i class="icon-reorder"></i>请填写参数信息
							</h4>
							<div class="tools">
						...
						<div class="portlet-body form">
							<%@ include file="/WEB-INF/content/cms/keyValue/form/ueditor.jsp"%>
						</div>
					</div>
				</div>
			</div>
